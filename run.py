...
def roi():
    ...
    print('The most profitable films of the decade:\n', sort_mostroi.head(10).to_string(index=False), '\n')
    print('Do you want to do a new search or find data?')
    welcome()
...
def get_film_info():
    ...
    if search:
        ...
        print('All you need to know about the film you were looking for\n', film_data, '\n')
        print('Do you want to do a new search or find data?')
        welcome()
    else:
...
def get_film_genres():
    ...
    if search:
        ...
        print('All the films of the genre you were looking for\n', film_genre, '\n')
        print('Do you want to do a new search or find data?')
        welcome()
    else:
...
def get_actor():
    ...
    if search:
        ...
        print('All the films of the actor you were looking for\n', actor_data, '\n')
        print('Do you want to do a new search or find data?')
        welcome()
...
def get_director():
    ...
    if search:
        ...
        print('All the films from the director you were looking for\n', director_data, '\n')
        print('Do you want to do a new search or find data?')
        welcome()
